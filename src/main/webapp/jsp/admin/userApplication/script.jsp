...
<script type="text/javascript">
    function handle(id,userId){
       $.ajax({
           url:'/admin/handleUserApplication',
           type:'post',
    ...
    jQuery(function ($) {
        ...
        jQuery(grid_selector).jqGrid({
            mtype: 'GET',
            url: '/admin/queryUserApplication',
            //subgrid options
            subGrid: false,
            ...
            height: 250,
            colNames: ['申请id', '申请时间', '申请人id', '申请人账户', '申请人昵称','申请人注册时间','驳回','同意'],
            colModel: [
                ...
                {name: 'registerDate', index: 'registerDate', width: 70, editable: false,formatter:date => new Date(date).toLocaleString()},
                {name: 'reject', index: 'reject', width: 60, editable: false},
                {name: 'agree', index: 'agree', width: 60, editable: false},
            ],
            viewrecords: true,
            rowNum: 10,
            rowList: [10, 20, 30],
