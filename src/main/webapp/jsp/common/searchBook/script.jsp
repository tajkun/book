...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            height: 250,
            colNames: ['书籍id', '书名','作者','出版日期','成书日期','申请人账户', '申请人昵称'],
            colModel: [
                {name: 'id', index: 'id', width: 60, sorttype: "int", editable: true},
                {name: 'name', index: 'name', width: 60, editable: true,formatter:data=>"<a href='/common/showArticle?bookId=#&status=2' target='_blank'>#</a>".replace('#',data.split(' ')[0]).replace('#',data.split(' ')[1])},
